...
if __name__ == "__main__":
    ...
    net_act = [Activation.logistic for i in range(len(net_arc) - 1)]
    ...
    with open('LRSZ.pkl'.format(n_layers, repeat_n, method), 'wb') as file:
        pkl.dump(
            [train_loss, test_loss, acc], file)
    net.saveModel('model/LRSZ.pkl'.format(n_layers, repeat_n, method))
